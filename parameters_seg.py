...
from models.gcn import SCN as ConvNet
...
class Parameters(object):
    ...
    _val_dir = None             # If None, validation data is randomly sampled from the training data (preferred)
    ...
    d = dict()
    d['image_size'] = (320, 320, 3)
    d['input_size'] = (320, 320, 3)
    ...
    d['init_learning_rate'] = 0.02
    d['momentum'] = 0.9
    d['moving_average_decay'] = 0.999
    d['batch_norm_decay'] = 0.999
    d['gradient_threshold'] = 5.0
    d['loss_weighting'] = 'balanced'    # None, 'balanced', [class0_weight, class1_weight, ...]
    d['loss_scaling_factor'] = 128

    d['learning_rate_boundaries'] = (30000, 50000)
    d['learning_rate_decay'] = 0.1

    # d['warmup_learning_rate'] = 0.01
    # d['learning_warmup_boundary'] = 2500
    ...
    d['rand_scale'] = (0.8, 1.25)  # Minimum and maximum scaling factors (x/y)
    d['rand_ratio'] = (0.8, 1.25)  # Minimum and maximum pixel aspect ratios (x/y)
    ...
    d['rand_crop_scale'] = (0.15 ** 2, 1.25 ** 2)  # Scale*input_size patch crop from an image
    d['rand_crop_ratio'] = (0.7, 1.43)

    d['rand_hue'] = 0.1  # Hue range in proportion
    ...
    d['rand_noise_stddev'] = 0.03
    d['rand_solarization'] = (0.0, 0.95)  # Solarization thresholds
    d['rand_posterization'] = (4.0, 8.0)  # Posterization bits
    ...
    # FIXME: Auxiliary classifier parameters
