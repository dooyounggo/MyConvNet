...
class UnprocessingDemosaic(Unprocessing):
    ...
    def _build_loss(self, **kwargs):
        ...
        denoising_loss_factor = kwargs.get('denoising_loss_factor', 1.0)
        with tf.variable_scope('loss'):
            ...
            if denoising_loss_factor > 0.0 and self.denoised is not None:
                loss += denoising_loss_factor*tf.losses.absolute_difference(mask*self.Y_mosaic, mask*self.denoised)
        return loss
