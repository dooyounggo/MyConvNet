...
class ResNetEven(ConvNet):  # Base model. ResNet-E-50
    ...
    def _build_model(self, **kwargs):
        ...
        with tf.variable_scope('block_0'):
            with tf.variable_scope('conv_0'):
                x = self.conv_layer(X_input, kernels[0] - 1, strides[0], channels[0]//2, padding='SAME', biased=False,
                                    verbose=True)
                d['block_0' + '/conv_0'] = x
...
class ResNetEven50(ResNetEven):
    pass


class ResNetEven101(ResNetEven):
    def _init_params(self):
        super()._init_params()
