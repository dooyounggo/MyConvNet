...
class Parameters(object):
    ...
    _train_dir = os.path.join(_root_dir, 'tfdatasets/stanford-dogs/train')
    ...
    d['init_from_public_checkpoint'] = False  # Whether to use pre-trained model in _pretrained_dir
    ...
    d['num_epochs'] = 120
    d['base_learning_rate'] = 1.0  # Learning rate = base_learning_rate*batch_size/256
    ...
    d['rand_rotation'] = 30  # Range in degrees
    d['rand_shear'] = 10  # Range in degrees
    ...
    d['rand_distortion_scheduling'] = True  # Augmentation scheduling (experimental)
