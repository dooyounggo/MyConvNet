...
| Model | Top-1 Acc. | Top-5 Acc. | Details | Hyperparameters | ckpt |
|---|---|---|---|---|---|
| ResNet-v1.5-50 |  |  | Inception preprocessing | [parameters.py](https://www.dropbox.com/s/lhmnshgfs9jvrfd/imagenet_res50.py?dl=0) |  |
